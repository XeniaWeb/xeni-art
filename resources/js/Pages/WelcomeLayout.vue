...
<template>
  <Head title="Landing"/>
    ...
    <div class="w-full z-50 top-0 py-3 sm:py-1 absolute">
      <div class="container flex items-center justify-between">
        <div>
          <Link href="/">
            <AppLogoXeniaWeb class="w-24 h-24 fill-current text-gray-500 hover:opacity-80 hover:scale-105 transition-all duration-250"/>
          </Link>
        </div>
        <!--TopMenu-->
    ...
    <div
      ...
      <div class="absolute right-0 min-h-screen w-2/3 bg-primary py-4 px-8 shadow md:w-1/3">
        <button
          ...
          <img src="/images/img/icon-close.svg" class="h-10 w-auto" alt=""/>
        </button>
    ...
    <div>
      <div
        ...
        style="background-image: url(/images/img/bg-hero.jpg)"
      >
        <div
        ...
        <div
          class="container relative z-30 pt-20 pb-12 sm:pt-56 sm:pb-48 lg:pt-64 lg:pb-32"
        >
          <div class="flex flex-col items-center justify-center lg:flex-row">
            <div class="rounded-full border-8 border-primary shadow-xl">
              <img
                src="/images/024.jpg"
                class="h-48 rounded-full sm:h-56 lg:h-72"
                alt="author"
              />
            </div>
            <div class="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
              <h1
                class="text-center font-header text-4xl text-white sm:text-left sm:text-5xl md:text-5xl"
              >
                Hello I'm Oksana Bürki!
              </h1><p class="font-normal text-white text-md md:text-xl my-4 max-w-xl">I have a passion for software. I enjoy creating tools that make life easier for people.</p>
              <div
      ...
      <div class="bg-grey-50" id="about">
        <div class="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
          <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
            <h2
              class="font-header text-2xl font-semibold uppercase text-primary sm:text-5xl lg:text-6xl"
            >
              Who am I?
            </h2>
            <h4
            ...
            >
              I'm Oksana Bürki, a Web Developer & Photographer
            </h4>
          ...
          <div class="w-full pl-0 pt-10 sm:w-3/4 lg:w-2/5 lg:pl-12 lg:pt-0">
            <div>
              <div class="flex items-end justify-between">
                ...
                <h3 class="font-body text-3xl font-bold text-primary">100%</h3>
              </div>
            ...
            <div class="pt-6">
              <div class="flex items-end justify-between">
                <h4 class="font-body font-semibold uppercase text-black">Photography</h4>
                <h3 class="font-body text-3xl font-bold text-primary">100%</h3>
              </div>
              <div class="mt-2 h-3 w-full rounded-full bg-lila">
                <div class="h-3 rounded-full bg-primary" style="width: 100%"></div>
        ...
        >
          <div class="group rounded px-8 py-12 shadow hover:bg-primary">
            <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div class="hidden group-hover:block">
                <img
                  src="/images/img/icon-development-white.svg"
                  alt="development icon"
                />
              </div>
              <div class="block group-hover:hidden">
                <img
                  src="/images/img/icon-development-black.svg"
                  alt="development icon"
                />
              </div>
            </div>
          ...
          <div class="group rounded px-8 py-12 shadow hover:bg-primary">
            <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div class="hidden group-hover:block">
                <img
                  src="/images/img/icon-content-white.svg"
                  alt="content marketing icon"
                />
              </div>
              <div class="block group-hover:hidden">
                <img
                  src="/images/img/icon-content-black.svg"
                  alt="content marketing icon"
                />
              </div>
            </div>
          ...
          <div class="group rounded px-8 py-12 shadow hover:bg-primary">
            <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div class="hidden group-hover:block">
                <img
                  src="/images/img/icon-mobile-white.svg"
                  alt="Mobile Application icon"
                />
              </div>
              <div class="block group-hover:hidden">
                <img
                  src="/images/img/icon-mobile-black.svg"
                  alt="Mobile Application icon"
                />
              </div>
            </div>
          ...
          <div class="group rounded px-8 py-12 shadow hover:bg-primary">
            <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div class="hidden group-hover:block">
                <img
                  src="/images/img/icon-email-white.svg"
                  alt="Email Marketing icon"
                />
              </div>
              <div class="block group-hover:hidden">
                <img
                  src="/images/img/icon-email-black.svg"
                  alt="Email Marketing icon"
                />
              </div>
            </div>
          ...
          <div class="group rounded px-8 py-12 shadow hover:bg-primary">
            <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div class="hidden group-hover:block">
                <img
                  src="/images/img/icon-design-white.svg"
                  alt="Theme Design icon"
                />
              </div>
              <div class="block group-hover:hidden">
                <img
                  src="/images/img/icon-design-black.svg"
                  alt="Theme Design icon"
                />
              </div>
            </div>
          ...
          <div class="group rounded px-8 py-12 shadow hover:bg-primary">
            <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div class="hidden group-hover:block">
                <img
                  src="/images/img/icon-graphics-white.svg"
                  alt="Graphic Design icon"
                />
              </div>
              <div class="block group-hover:hidden">
                <img
                  src="/images/img/icon-graphics-black.svg"
                  alt="Graphic Design icon"
                />
              </div>
            </div>
      ...
      <div class="container py-16 md:py-20" id="portfolio">
        ...
        >
          ...
          >
            <img
              src="/images/img/portfolio-apple.jpeg"
              class="w-full shadow"
              alt="portfolio image"
            />
          </a>
          ...
          >
            <img
              src="/images/img/portfolio-stripe.jpeg"
              class="w-full shadow"
              alt="portfolio image"
            />
          </a>
          ...
          >
            <img
              src="/images/img/portfolio-fedex.jpeg"
              class="w-full shadow"
              alt="portfolio image"
            />
          </a>
          ...
          >
            <img
              src="/images/img/portfolio-microsoft.jpeg"
              class="w-full shadow"
              alt="portfolio image"
            />
          </a>
      ...
      <div class="bg-grey-50" id="clients">
        ...
        <span class="m-8 block">
          <img
            src="/images/img/logo-coca-cola.svg"
            alt="client logo"
          ...
          />
              ...
              <span class="m-8 block">
          <img
            src="/images/img/logo-netflix.svg"
            alt="client logo"
            class="mx-auto block h-12 w-auto"
          />
        </span>
              ...
              <span class="m-8 block">
          <img
            src="/images/img/logo-amazon.svg"
            alt="client logo"
            class="mx-auto block h-12 w-auto"
          />
        </span>
              ...
              <span class="m-8 block">
          <img
            src="/images/img/logo-stripe.svg"
            alt="client logo"
            class="mx-auto block h-12 w-auto"
          />
        </span>
    ...
    ></span>
          ...
          <span class="shrink-0">
            <img
              src="/images/img/logo-spotify.svg"
              class="h-auto w-32"
              alt="company logo"
            />
          </span>
          ...
          <span class="shrink-0">
            <img
              src="/images/img/logo-microsoft.svg"
              class="h-auto w-32"
              alt="company logo"
            />
          </span>
      ...
      <div
        ...
        style="background-image: url(/images/img/experience-figure.png)"
        id="statistics"
      >
        <div class="container">
          <div
          ...
          >
            <div class="grid grid-cols-2 gap-5 md:gap-8 xl:grid-cols-4 xl:gap-5">
              ...
              >
                <div>
                  <img
                    src="/images/img/icon-project.svg"
              ...
              >
                <div>
                  <img
                    src="/images/img/icon-puzzle.svg"
                    class="mx-auto h-12 w-auto md:h-20"
                    alt="icon puzzle"
                  />
                </div>
        ...
        <div class="container py-16 md:py-20">
          ...
          >
            <a href="/post" class="shadow">
              <div
                style="background-image: url(/images/img/post-01.png)"
          ...
          >
            ...
            <a href="/post" class="shadow">
              <div
                style="background-image: url(/images/img/post-02.png)"
                class="group relative h-72 bg-cover bg-center bg-no-repeat sm:h-84 lg:h-64 xl:h-72"
              >
          <span
            class="absolute inset-0 block bg-gradient-to-b from-blog-gradient-from to-blog-gradient-to bg-cover bg-center bg-no-repeat opacity-10 transition-opacity group-hover:opacity-50"
          ...
          >
            ...
            <a href="/post" class="shadow">
              <div
                style="background-image: url(/images/img/post-03.png)"
                class="group relative h-72 bg-cover bg-center bg-no-repeat sm:h-84 lg:h-64 xl:h-72"
              >
          <span
            class="absolute inset-0 block bg-gradient-to-b from-blog-gradient-from to-blog-gradient-to bg-cover bg-center bg-no-repeat opacity-10 transition-opacity group-hover:opacity-50"
      ...
      <div
        ...
        style="background-image: url(/images/img/map.png)"
      ></div>
      <!--Section Subscribe-->
      <div
        class="relative bg-primary bg-cover bg-center bg-no-repeat py-16 bg-blend-multiply lg:py-24"
        style="background-image: url(/images/img/bg-cta.jpg)"
      >
