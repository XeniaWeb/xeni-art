...
<template>
    ...
    >
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-end border-4 border-indigo-400">
            <Link
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8 border-4 border-indigo-400">
            <div class="flex justify-center border-4 border-indigo-400">
                <svg
                    viewBox="0 0 62 65"
                    fill="none"
            ...
            <div class="mt-16 border-4 border-indigo-400">
            ...
            <div class="flex justify-center mt-16 px-6 sm:items-center sm:justify-between border-4 border-indigo-400">
